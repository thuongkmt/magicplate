...
using MvvmHelpers;
using KonbiCloud.Authorization.Users.Profile;
...
using KonbiCloud.Controls;
using KonbiCloud.Dto;
using KonbiCloud.Extensions;
using KonbiCloud.Localization;
using KonbiCloud.UI;
using KonbiCloud.UI.Assets;
using KonbiCloud.Views;
using DependencyResolver = KonbiCloud.Core.Dependency.DependencyResolver;
...
namespace KonbiCloud.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "KonbiCloud";
