...
using KonbiCloud.Web.Public.Startup;
using KonbiCloud.Web.Session;

namespace KonbiCloud.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : KonbiCloudViewComponent
    {
