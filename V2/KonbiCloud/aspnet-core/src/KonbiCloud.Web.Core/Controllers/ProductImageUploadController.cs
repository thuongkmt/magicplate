...
{
    [AbpMvcAuthorize]
    public class ProductImageUploadController : KonbiCloudControllerBase
    {
        private readonly IBinaryObjectManager _binaryObjectManager;
        private readonly IConfigurationRoot _appConfiguration;

        public ProductImageUploadController(IBinaryObjectManager binaryObjectManager, IHostingEnvironment env)
        {
        ...
        public async Task<List<string>> UploadFiles()
        {
            try
            {
                ...
                foreach (var file in files)
                {
                    ...
                    var imgFolder = _appConfiguration[AppSettingNames.ProductImageFolder];
        ...
        [HttpPost]
        public async Task<bool> ImportProductUploadFiles()
        {
            try
            {
                var files = Request.Form.Files;
