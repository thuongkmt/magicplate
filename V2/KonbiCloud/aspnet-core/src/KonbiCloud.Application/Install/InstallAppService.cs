...
namespace KonbiCloud.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : KonbiCloudAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<KonbiCloudDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(KonbiCloudConsts.ConnectionStringName).Value.ToString();
        }
