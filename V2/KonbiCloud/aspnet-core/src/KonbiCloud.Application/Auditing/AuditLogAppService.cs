...
using KonbiCloud.Auditing.Exporting;
using KonbiCloud.Authorization;
using KonbiCloud.Authorization.Users;
using KonbiCloud.Dto;
using EntityHistoryHelper = KonbiCloud.EntityHistory.EntityHistoryHelper;

namespace KonbiCloud.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : KonbiCloudAppServiceBase, IAuditLogAppService
    {
