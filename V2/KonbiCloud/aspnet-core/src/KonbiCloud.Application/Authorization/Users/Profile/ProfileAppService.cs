...
using KonbiCloud.Authorization.Users.Profile.Cache;
using KonbiCloud.Authorization.Users.Profile.Dto;
using KonbiCloud.Dto;
using KonbiCloud.Friendships;
using KonbiCloud.Gdpr;
using KonbiCloud.Identity;
using KonbiCloud.Security;
using KonbiCloud.Storage;
using KonbiCloud.Timing;

namespace KonbiCloud.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : KonbiCloudAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("KonbiCloud",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("KonbiCloud",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
