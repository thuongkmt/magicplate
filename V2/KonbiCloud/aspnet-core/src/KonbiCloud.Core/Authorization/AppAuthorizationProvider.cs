...
namespace KonbiCloud.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            Products.CreateChildPermission(AppPermissions.Pages_Products_Import, L("ImportProduct"));
            Products.CreateChildPermission(AppPermissions.Pages_Products_Export, L("ExportProduct"));
