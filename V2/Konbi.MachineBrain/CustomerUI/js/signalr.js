...
/* harmony import */ var _Subject__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(15);
...
var VERSION = "3.0.0-preview-18607-0108";
...
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
/* harmony import */ var _Subject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
...
var HubConnection = /** @class */ (function () {
    ...
    HubConnection.prototype.stream = function (methodName) {
        ...
        var streams = this.replaceStreamingParams(args);
    ...
    HubConnection.prototype.send = function (methodName) {
        ...
        var streams = this.replaceStreamingParams(args);
        var sendPromise = this.sendWithProtocol(this.createInvocation(methodName, args, true));
        this.launchStreams(streams, sendPromise);
        return sendPromise;
    };
    HubConnection.prototype.nextStreamId = function () {
        this.streamId += 1;
    ...
    HubConnection.prototype.launchStreams = function (streams, promiseQueue) {
        ...
        var _loop_1 = function (streamId) {
            streams[streamId].subscribe({
                complete: function () {
                    promiseQueue = promiseQueue.then(function () { return _this.sendWithProtocol(_this.createStreamCompleteMessage(streamId)); });
                },
                error: function (err) {
                    var message;
                    ...
                    promiseQueue = promiseQueue.then(function () { return _this.sendWithProtocol(_this.createStreamCompleteMessage(streamId, message)); });
                },
                next: function (item) {
                    promiseQueue = promiseQueue.then(function () { return _this.sendWithProtocol(_this.createStreamDataMessage(streamId, item)); });
                },
            });
        };
    ...
    HubConnection.prototype.createStreamDataMessage = function (id, item) {
        return {
            item: item,
            streamId: id,
            type: _IHubProtocol__WEBPACK_IMPORTED_MODULE_1__["MessageType"].StreamData,
        };
    };
    HubConnection.prototype.createStreamCompleteMessage = function (id, error) {
        if (error) {
            return {
                error: error,
                streamId: id,
                type: _IHubProtocol__WEBPACK_IMPORTED_MODULE_1__["MessageType"].StreamComplete,
            };
        }
        return {
            streamId: id,
