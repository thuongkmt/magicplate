...
namespace KonbiCloud.Migrations
{
    ...
    [Migration("20191204044617_AddServiceTable")]
            ...
            modelBuilder.Entity("KonbiCloud.Services.Service", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreationTime = new DateTime(2019, 12, 4, 11, 46, 15, 643, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "MagicPlate Server", ServiceName = "MagicPlateServer.Service" },
                        new { Id = 2, CreationTime = new DateTime(2019, 12, 4, 11, 46, 15, 643, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "RabbitMq Server", ServiceName = "RabbitMqServer.Service" },
                        new { Id = 3, CreationTime = new DateTime(2019, 12, 4, 11, 46, 15, 643, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "Tag reader", ServiceName = "TagReader.Service" },
                        new { Id = 4, CreationTime = new DateTime(2019, 12, 4, 11, 46, 15, 643, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "LightAlarm", ServiceName = "LightAlarm.Service" },
                        new { Id = 5, CreationTime = new DateTime(2019, 12, 4, 11, 46, 15, 643, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "Camera", ServiceName = "Camera.Service" },
                        new { Id = 6, CreationTime = new DateTime(2019, 12, 4, 11, 46, 15, 643, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = " Payment Controller", ServiceName = "PaymentController.Service" }
                    );
                });
