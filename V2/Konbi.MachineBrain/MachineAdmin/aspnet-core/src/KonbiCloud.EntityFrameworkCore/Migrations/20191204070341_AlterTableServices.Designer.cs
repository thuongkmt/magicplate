...
namespace KonbiCloud.Migrations
{
    ...
    [Migration("20191204070341_AlterTableServices")]
    partial class AlterTableServices
    {
            ...
            modelBuilder.Entity("KonbiCloud.Services.Service", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreationTime = new DateTime(2019, 12, 4, 14, 3, 40, 888, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "MagicPlate Server", Type = "MagicPlateServer.Service" },
                        new { Id = 2, CreationTime = new DateTime(2019, 12, 4, 14, 3, 40, 889, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "RabbitMq Server", Type = "RabbitMqServer.Service" },
                        new { Id = 3, CreationTime = new DateTime(2019, 12, 4, 14, 3, 40, 889, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "Tag reader", Type = "TagReader.Service" },
                        new { Id = 4, CreationTime = new DateTime(2019, 12, 4, 14, 3, 40, 889, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "LightAlarm", Type = "LightAlarm.Service" },
                        new { Id = 5, CreationTime = new DateTime(2019, 12, 4, 14, 3, 40, 889, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "Camera", Type = "Camera.Service" },
                        new { Id = 6, CreationTime = new DateTime(2019, 12, 4, 14, 3, 40, 889, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = " Payment Controller", Type = "PaymentController.Service" }
                    );
                });
