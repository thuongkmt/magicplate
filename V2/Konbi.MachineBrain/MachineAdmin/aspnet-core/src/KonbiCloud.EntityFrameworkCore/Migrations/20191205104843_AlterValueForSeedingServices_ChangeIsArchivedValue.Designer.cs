...
namespace KonbiCloud.Migrations
{
    ...
    [Migration("20191205104843_AlterValueForSeedingServices_ChangeIsArchivedValue")]
    partial class AlterValueForSeedingServices_ChangeIsArchivedValue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KonbiCloud.ProductMenu.ProductMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KonbiCloud.Services.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasData(
                        new { Id = 1, CreationTime = new DateTime(2019, 12, 5, 17, 48, 42, 837, DateTimeKind.Local), IsArchived = false, IsDeleted = false, Name = "MagicPlate Server", TenantId = 1, Type = "MagicPlateServer.Service" },
                        new { Id = 2, CreationTime = new DateTime(2019, 12, 5, 17, 48, 42, 837, DateTimeKind.Local), IsArchived = false, IsDeleted = false, Name = "RabbitMq Server", TenantId = 1, Type = "RabbitMqServer.Service" },
                        new { Id = 3, CreationTime = new DateTime(2019, 12, 5, 17, 48, 42, 837, DateTimeKind.Local), IsArchived = false, IsDeleted = false, Name = "Tag reader", TenantId = 1, Type = "TagReader.Service" },
                        new { Id = 4, CreationTime = new DateTime(2019, 12, 5, 17, 48, 42, 837, DateTimeKind.Local), IsArchived = false, IsDeleted = false, Name = "LightAlarm", TenantId = 1, Type = "LightAlarm.Service" },
                        new { Id = 5, CreationTime = new DateTime(2019, 12, 5, 17, 48, 42, 837, DateTimeKind.Local), IsArchived = false, IsDeleted = false, Name = "Camera", TenantId = 1, Type = "Camera.Service" },
                        new { Id = 6, CreationTime = new DateTime(2019, 12, 5, 17, 48, 42, 837, DateTimeKind.Local), IsArchived = false, IsDeleted = false, Name = " Payment Controller", TenantId = 1, Type = "PaymentController.Service" }
                    );
                });
            ...
            modelBuilder.Entity("KonbiCloud.Prices.PriceStrategy", b =>
                {
                    ...
                    b.HasOne("KonbiCloud.ProductMenu.ProductMenu")
