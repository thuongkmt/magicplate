...
namespace KonbiCloud.Migrations
{
    ...
    [Migration("20191204085635_AlterTableServices_AddTenantIdForSeedingData")]
    partial class AlterTableServices_AddTenantIdForSeedingData
    {
            ...
            modelBuilder.Entity("KonbiCloud.Services.Service", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreationTime = new DateTime(2019, 12, 4, 15, 56, 34, 784, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "MagicPlate Server", TenantId = 1, Type = "MagicPlateServer.Service" },
                        new { Id = 2, CreationTime = new DateTime(2019, 12, 4, 15, 56, 34, 784, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "RabbitMq Server", TenantId = 1, Type = "RabbitMqServer.Service" },
                        new { Id = 3, CreationTime = new DateTime(2019, 12, 4, 15, 56, 34, 784, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "Tag reader", TenantId = 1, Type = "TagReader.Service" },
                        new { Id = 4, CreationTime = new DateTime(2019, 12, 4, 15, 56, 34, 784, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "LightAlarm", TenantId = 1, Type = "LightAlarm.Service" },
                        new { Id = 5, CreationTime = new DateTime(2019, 12, 4, 15, 56, 34, 784, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = "Camera", TenantId = 1, Type = "Camera.Service" },
                        new { Id = 6, CreationTime = new DateTime(2019, 12, 4, 15, 56, 34, 784, DateTimeKind.Local), IsArchived = true, IsDeleted = false, Name = " Payment Controller", TenantId = 1, Type = "PaymentController.Service" }
                    );
                });
