...
namespace KonbiCloud.Web.Authentication.JwtBearer
{
    public class KonbiCloudJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public KonbiCloudJwtSecurityTokenHandler()
        {
