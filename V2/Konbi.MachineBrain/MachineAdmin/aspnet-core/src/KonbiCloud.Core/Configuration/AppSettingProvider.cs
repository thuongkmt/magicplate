    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[] {
                ...
                new SettingDefinition(AppSettingNames.MachineId, "RFID001", scopes: SettingScopes.All, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.MachineName, "MCRFID001", scopes: SettingScopes.All, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.SyncServerUrl, "http://localhost:22743", scopes: SettingScopes.All, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.MdbCashlessPort, "COM1", scopes: SettingScopes.All, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.AllowPushDishToServer, "True", scopes: SettingScopes.All, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.ScanningStableAfterMiliseconds, "500", scopes: SettingScopes.All, isVisibleToClients: true),
                ...
                new SettingDefinition(AppSettingNames.PrintIsEnabled, "True", scopes: SettingScopes.All, isVisibleToClients: true),
                // defining lastSynced time stamp for entities
                new SettingDefinition(AppSettingNames.ProductMenuEntityLastSynced, "0", scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.PlateCategoryEntityLastSynced, "0", scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.PlateEntityLastSynced, "0", scopes: SettingScopes.Tenant, isVisibleToClients: true),

                new SettingDefinition(AppSettingNames.CategoryEntityLastSynced, "0", scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.ProductEntityLastSynced, "0", scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.SessionEntityLastSynced, "0", scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.InventoryEntityLastSynced, "0", scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.PaymentsAccept, "IUC_CEPAS, IUC_CONTACTLESS, QR_DASH", scopes: SettingScopes.Tenant, isVisibleToClients: true),
