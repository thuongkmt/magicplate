namespace KonbiCloud.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        public static class MagicplateSettings
        {
            public static class TaxSettings
            {
                public const string TaxName = "App.Magicplate.Tax.Name";
                public const string TaxType = "App.Magicplate.Tax.Type";
                public const string TaxPercentage = "App.Magicplate.Tax.Percentage";
            }
        }
