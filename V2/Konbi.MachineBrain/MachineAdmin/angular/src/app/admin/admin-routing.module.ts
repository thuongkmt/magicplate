...
import { SyncSettingComponent } from './sync-setting/sync-setting.component';
        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'syncsetting', component: SyncSettingComponent, data: { permission: 'Pages.Administration.SyncSetting' } },
                ]
            }
        ])
    ],
