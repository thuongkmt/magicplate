...
namespace RFIDLIB
{
    class rfidlib_aip_iso15693
    {
        ...
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_ReadConfiguration(UIntPtr hr, /*in */
                                            UIntPtr ht, /*in */
                                            Byte Pointer,
                                            ref Byte RegisterValue);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_WriteConfiguration(UIntPtr hr, /*in */
                                                    UIntPtr ht, /*in */
                                                    Byte Pointer,
                                                    Byte RegisterValue);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_ReadDynamicConfiguration(UIntPtr hr, /*in */
                                                            UIntPtr ht, /*in */
                                                            Byte Pointer,
                                                            ref Byte RegisterValue);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_WriteDynamicConfiguration(UIntPtr hr, /*in */
                                                            UIntPtr ht, /*in */
                                                            Byte Pointer,
                                                            Byte RegisterValue);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_ManageGPO(UIntPtr hr, /*in */UIntPtr ht, /*in */Byte gpo);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_WriteMessage(UIntPtr hr, /*in */
                                                UIntPtr ht, /*in */
                                                Byte[] msgData,
                                                Byte msgLen);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_ReadMessageLength(UIntPtr hr, /*in */
                                                    UIntPtr ht, /*in */
                                                    ref Byte msgLength);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_ReadMessage(UIntPtr hr, /*in */
                                                UIntPtr ht, /*in */
                                                Byte Pointer,/*in*/
                                                Byte ReadCount,/*in*/
                                                Byte[] msgBuf,/*out*/
                                                ref UInt32 nSize /*in/out*/);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_WritePassword(UIntPtr hr, /*in */
                                                UIntPtr ht, /*in */
                                                Byte passwordNum,
                                                Byte[] password/*8 bytes*/);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ST25DV04K_PresentPassword(UIntPtr hr, /*in */
                                        UIntPtr ht, /*in */
                                        Byte passwordNum,
                                        Byte[] password/*8 bytes*/);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_EnableEAS(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_DisableEAS(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_LockEAS(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_ActiveEAS(UIntPtr hr, UIntPtr ht,Byte AddressMode,Byte EASIdMaskLen, UInt16 EASID,Byte []EASData,ref UInt32 nSize);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_EASCheck(UIntPtr hr, UIntPtr ht, ref Byte EASFlag);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_ProtectEAS(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_WriteEASID(UIntPtr hr, UIntPtr ht, UInt16 EASID);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_WriteEASCfg(UIntPtr hr, UIntPtr ht, Byte cfg);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_ChangeKey(UIntPtr hr, UIntPtr ht, Byte KeyIndentifier, UInt32 Password);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_ProtectMemoryPage(UIntPtr hr, UIntPtr ht, UInt32 PageNo, Byte ProtectStatus);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_GetMultipleBlocksProtectionStatus(UIntPtr hr, UIntPtr ht, Byte BlockAddress, Byte BlockNumber, Byte[] buffer, ref UInt32 nSize);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_Destroy(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_EnablePrivacy(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_DisablePrivacy(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_EnableRandomID(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_DisableRandomID(UIntPtr hr, UIntPtr ht);

        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int EM4237SLI_Login(UIntPtr hr, UIntPtr ht, UInt32 password);
