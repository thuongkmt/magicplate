...
namespace KonbiBrain.Common.Services
{
    public class NsqMessageProducerService:IMessageProducerService
    {
        ...
        public bool SendBarcodecommand(object command)
        {
            return SendNsqCommand(NsqTopics.BARCODE_SCANNER_TOPIC, command);
        }
        ...
        public bool SendAlarmLightCommand(object command)
        {
            return SendNsqCommand(NsqTopics.ALARM_LIGHT_REQUEST_TOPIC, command);
        }
        public bool SendAlarmLightResponseCommand(object command)
        {
            return SendNsqCommand(NsqTopics.ALARM_LIGHT_RESPONSE_TOPIC, command);
        }
