...
using KonbiCloud.MultiTenancy.Demo;
...
namespace KonbiCloud.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(KonbiCloudConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
